# deep_reinforcement_learning/examples/lunarlander_dqn_per.py
"""
...
5. **Evaluation**: Runs the trained agent to demonstrate its performance.
6. **Output**: Saves the trained model and prints the average reward over the last 100 episodes.
...
def main():
    ...
    config = drl.DQNConfig(
        ...
        checkpoint_path="dqn_per_lunarlander.model",    # Path to save model
        plot_path="dqn_per_lunarlander_rewards.png",    # Path to save rewards plot
